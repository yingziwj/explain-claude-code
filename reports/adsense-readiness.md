...
| /guides/case-study-team-pilot | 10 | yes | yes | yes |
| /guides/choose-subagents-plugins-mcp | 12 | yes | yes | yes |
| /guides/claude-code-vs-other-tools | 8 | yes | yes | yes |
| /guides/commands-not-working | 10 | yes | yes | yes |
| /guides/common-beginner-mistakes | 11 | yes | yes | yes |
| /guides/common-errors-checklist | 9 | yes | yes | yes |
...
| /guides/installation-by-platform | 8 | yes | yes | yes |
| /guides/installation-troubleshooting | 12 | yes | yes | yes |
| /guides/login-troubleshooting | 12 | yes | yes | yes |
| /guides/mcp-connection-troubleshooting | 12 | yes | yes | yes |
| /guides/permission-blocked-troubleshooting | 12 | yes | yes | yes |
| /guides/permission-boundaries | 8 | yes | yes | yes |
