...
const pageSeeds: Record<string, ContentSeed> = {
	...
	'agent-teams': {
		summary: ['这一页讲的是“多个人一起干一摊活”这件事。', '不是一个 Claude 自己来回切角色，而是真的拉出一支小队伍一起干。'],
		explain: ['你就把它想成包工头带几个工人。你平时主要跟带队的那个说清楚要干什么，带队的再把活分给下面的人。', '这种办法适合活大、能拆开、能同时干的时候。要是本来就一条线慢慢做，小队伍反而会显得吵。'],
		practice: ['先问自己一句：这活能不能分成几路同时干？不能，就别急着拉队伍。', '真要拉队伍，也先把“谁去查、谁去改、谁去验”说清楚，别让几个人撞到同一块地。'],
		steps: [{ title: '适合团队的活', body: '下面这几种活，拉一支队伍一起干通常更划算。', code: `1. 好几个地方同时排查问题\n2. 一拨人改代码，另一拨人补测试\n3. 代码、文档、验收说明分开推进`, kind: 'code' }]
	},
	plugins: {
